...
import app.domain.port.in.DiagnosticAid.DiagnosticAid;
import app.domain.port.in.DiagnosticAid.DiagnosticAidRepository;
import app.domain.port.in.Medication.Medication;
import app.domain.port.in.Medication.MedicationRepository;
import app.domain.port.in.Procedure.Procedure;
import app.domain.port.in.Procedure.ProcedureRepository;
